...
namespace GetStartedWithData
{
    ...
    "https://devcampamsdemo.azure-mobile.net/",
    "rkBiIAbHkfUQGQRRmTtFrLVTDAaoYQ80"
);
        ...
        private async void InitNotificationsAsync()
        {
            ...
            var hub = new NotificationHub("devcampamsdemohub", "Endpoint=sb://devcampamsdemohub-ns.servicebus.windows.net/;SharedAccessKeyName=DefaultListenSharedAccessSignature;SharedAccessKey=DmCr1yfZubowdfDrzpPkEls6UdSPf0AVYY68uAnX/SM=");              
